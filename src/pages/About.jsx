        ...
        <div className="py-5 align-items-center row">
          <div className="col-md-8">
            ...
            <p className="text-justify">
              Được thành lập từ năm 2013 bởi những chàng trai 9x đầy nhiệt huyết
              và đam mê công nghệ, với xuất phát điểm là số vốn ít ỏi 8,5 triệu
              đồng cho một cửa hàng laptop nhỏ trên đường Láng (Hà Nội), cho đến
              nay ThinkGroup đã phát triển và vận hành nhiều cửa hàng lớn nhỏ
              bán lẻ máy tính và phụ kiện công nghệ trên hai miền đất nước dưới
              thương hiệu ThinkPro, trở thành đơn vị tiên phong trong việc thay
              đổi mô hình bán lẻ và trải nghiệm công nghệ tại Việt Nam với chuỗi
              cửa hàng tiêu chuẩn mới - Dạo Bước Công Nghệ.
            </p>
          </div>
          <div className="col-md-4">
            <motion.img
        ...
        <div className="py-5 align-items-center row">
          ...
          <div className="col-md-8 col2">
            ...
            <p className="text-justify">
              ...
              khách hàng làm trung tâm, bằng kiến thức chuyên môn, sự chân thành
              và nhiệt huyết của tuổi trẻ, đồng thời ứng dụng công nghệ số để
              tối ưu và linh hoạt, mang lại trải nghiệm tốt nhất dành cho khách
              hàng qua từng dịch vụ mà công ty cung cấp.
            </p>
          </div>
        </div>
        <div className="py-5 align-items-center row">
