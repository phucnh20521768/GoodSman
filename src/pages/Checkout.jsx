          ...
          <Row className="">
            <Col className="col-lg-8 col-12 p-xl-5 py-5">
              ...
              <div id="infoCustomerField">
                <input type="text" className="form-control" id="nameCustomer" placeholder="Họ và tên"></input>
                <input type="email" className="form-control my-2" id="emailCustomer" placeholder="Địa chỉ email"></input>
                <input type="tel" className="form-control" id="phoneCustomer" placeholder="Số điện thoại"></input>
              </div>
              ...
              <div id="addressField" className="container">
                <div className="row">
                  <div className="d-flex justify-content-between col-md-6 col-12 p-0">
                    <input type="text" className="form-control" id="addressCustomer" placeholder="Địa chỉ nhà"></input>
