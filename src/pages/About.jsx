                ...
                <div className='p-5 align-items-center row'>
                    ...
                    <div className='col-md-8'>
                        <div className='text-end fw-bold waviy'>
                            ...
                            <span style={{ "--i": 2 }}>Ứ</span>
                            <span style={{ "--i": 4 }} className="left">M</span>
                            <span style={{ "--i": 5 }}>Ệ</span>
                            <span style={{ "--i": 6 }}>N</span>
                            <span style={{ "--i": 7 }}>H</span>
                            <span style={{ "--i": 9 }} className="left">C</span>
                            <span style={{ "--i": 10 }}>Ủ</span>
                            <span style={{ "--i": 11 }}>A</span>
                            <span style={{ "--i": 13 }} className="left">C</span>
                            <span style={{ "--i": 14 }}>H</span>
                            <span style={{ "--i": 15 }}>Ú</span>
                            <span style={{ "--i": 16 }}>N</span>
                            <span style={{ "--i": 17 }}>G</span>
                            <span style={{ "--i": 19 }} className="left">T</span>
                            <span style={{ "--i": 20 }}>Ô</span>
                ...
                <div className='p-5 align-items-center row'>
                    <div className='col-md-8'>
                        <div className='fw-bold waviy'>
                            ...
                            <span style={{ "--i": 6 }}>Ầ</span>
                            <span style={{ "--i": 7 }}>M</span>
                            <span style={{ "--i": 9 }} className="left">N</span>
                            <span style={{ "--i": 10 }}>H</span>
                            <span style={{ "--i": 11 }}>Ì</span>
                            <span style={{ "--i": 11 }}>N</span>
                            <span style={{ "--i": 13 }} className="left">C</span>
                            <span style={{ "--i": 14 }}>Ủ</span>
